...
//        return null;
    ...
    public Stream<Person> getUniquelyNamedPeople() {
        ...
        return people.stream().filter((Person p) -> nameSet.add(p.getName())); //will return false if it cannot be added
//        return people.stream().filter(distinctByKey(Person::getName)); //emory made helper method
//        return null;
    }
